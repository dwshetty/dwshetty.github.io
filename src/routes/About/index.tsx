    ...
    <section className={styles.wrapper}>
      ...
      <blockquote cite="https://www.linkedin.com/in/dwitesh-shetty-66810b156/">
        <em>
          ...
          including but not limited to HTML5, CSS3, JavaScript, Typescript,
          ReactJS, NextJS at par with latest standards.
        </em>
      </blockquote>
      <br />
      <hr />
      ...
      <article className={styles.professionalSkills}>
        <ul>
          ...
          <li>
            <strong>Others:</strong> Adobe Experience Manager, Azure DevOps, C,
            Confluence, Eclipse, Git, Github, Gitlab, JIRA, LaTeX, Libre,
            Matlab, MS Office, Netbeans, NVDA, Postman, Slack, VS Code, Windows,
            Wordpress
          </li>
        </ul>
      </article>
      ...
      <article className={styles.personalSkills}>
        <ul>
          <li>
            ...
            senior management when gathering requirements, scrutinizing product
            features and listing out possible strategies and solutions.
          </li>
          <li>
          ...
          <li>
            Can stretch work hours when necessary, but prefers to work smartly,
            with no compromise on final product quality.
          </li>
        </ul>
      </article>
    </section>
